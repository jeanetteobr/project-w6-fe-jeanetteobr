    ...
    return (
      <div id='edit-book' className='book-container'>
        <form onSubmit={this.handleSubmit}>
          ...
          <input className='input' id='cover-img' type='text' value={books.coverImageUrl} onChange={(e) => { this.props.updateBook(books.id, 'cover url', e.target.value) }} />
          ...
          <input className='input' id='pubish-date' type='text' value={books.publicationDate} onChange={(e) => { this.props.updateBook(books.id, 'publish date', e.target.value) }} />
          <label for='detailed-desc'>Detailed description:</label>
          <textarea className='textarea' id='detailed-desc' form='edit-book' type='text' rows='6' value={books.detailedDescription} />
